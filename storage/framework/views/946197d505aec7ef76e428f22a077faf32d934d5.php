            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="customer-img mb-120">
                        <img src="<?php echo e(asset('img/hero/bussines_cover.jpg')); ?>" class="customar-img1" alt="">
                        <img src="<?php echo e(asset('img/customer/customar2.png')); ?>" class="customar-img2" alt="">
                ...
                <div class="col-xl-9 col-lg-9 col-md-9">
                    <div class="h1-testimonial-active">
                        ...
                        <div class="single-testimonial pt-65">
                            ...
                            <div class="font-back-tittle mb-105">
                                <div class="archivment-front">
                                    <img src="<?php echo e(asset('img/team/Endri.jpg')); ?>" style="width:100px; height: 100px; border-radius: 50%;" alt="">
                                </div>
                        ...
                        <div class="single-testimonial  pt-65">
                            ...
                            <div class="font-back-tittle mb-105">
                                <div class="archivment-front">
                                    <img src="<?php echo e(asset('img/team/Dea.png')); ?>" style="width:100px; height: 100px; border-radius: 50%;" alt="">
                                </div>
                                <h3 class="archivment-back">Developers</h3>
                            </div>
                            <!-- Testimonial Content -->
                         ...
                         <div class="single-testimonial  pt-65">
                            ...
                            <div class="font-back-tittle mb-105">
                                <div class="archivment-front">
                                    <img src="<?php echo e(asset('img/team/Eniani.png')); ?>" style="width:100px; height: 100px; border-radius: 50%;" alt="">
                                </div>
                                <h3 class="archivment-back">Developers</h3>
                            </div>
                            <!-- Testimonial Content -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tp\resources\views/pages/about.blade.php ENDPATH**/ ?>