        ...
        <div class="form-froup pb-3">
         ...
         <?php if(Auth::user()->is_business == 1): ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('checkin', $post->checkin_date, ['class' => 'form-control col-sm-4', 'placeholder' => 'dd/mm/yyyy'])); ?>

            </div>
            <div class="form-group">
                <?php echo e(Form::label('checkout', 'Checkout date')); ?>

                <?php echo e(Form::text('checkout', $post->checkout_date, ['class' => 'form-control col-sm-4', 'placeholder' => 'dd/mm/yyyy'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('adults', $post->checkout_date, ['class' => 'form-control col-sm-4', 'placeholder' => 'Number of adults'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('children', $post->kids, ['class' => 'form-control col-sm-4', 'placeholder' => 'Number of children'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('rooms', $post->rooms, ['class' => 'form-control col-sm-4', 'placeholder' => 'Number of rooms available'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('price', $post->price, ['class' => 'form-control col-sm-4', 'placeholder' => 'Enter a price'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tp\resources\views/posts/edit.blade.php ENDPATH**/ ?>