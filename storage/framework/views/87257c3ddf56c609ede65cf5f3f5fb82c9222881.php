...
<?php echo Form::open(['action' => ['BusinessController@update', $user->id], 'method' => 'POST', 'enctype' =>
'multipart/form-data']); ?>
...
<div class="form-group ">
    ...
    <?php echo e(Form::text('name', $user->business_name, ['class' => 'form-control col-sm-4', 'placeholder' => 'Business name'])); ?>
...
<div class="form-group ">
    ...
    <?php echo e(Form::text('address', $user->business_address, ['class' => 'form-control col-sm-4', 'placeholder' => 'Business address'])); ?>
...
<div class="form-group ">
    ...
    <?php echo e(Form::text('city', $user->business_city, ['class' => 'form-control col-sm-4', 'placeholder' => 'Business city'])); ?>

</div>

<div class="form-group ">
    <?php echo e(Form::label('number', 'Business Tel')); ?>

    <?php echo e(Form::text('number', $user->business_number, ['class' => 'form-control col-sm-4', 'placeholder' => 'Business number'])); ?>

</div>

 
<?php echo e(Form::hidden('_method', 'PUT')); ?> 
<?php echo e(Form::submit('Update', ['class' => 'genric-btn info'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tp\resources\views/business/edit.blade.php ENDPATH**/ ?>